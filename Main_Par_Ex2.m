...
%% Example 2
%Example 2 computes the cost function for 2 controlers under 12 load cases
...
ctrlFolder             = [pwd '/_Controller/Example2/']       ; % Location of Simulink files
...
ctrlMdls               = {[0.006275604; 0.0008965149]};
